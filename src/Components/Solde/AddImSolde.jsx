...
const AddImSolde = () => {
    ...
    // console.log(personToFiltre)
    const handleSubmit = (e) => {
        e.preventDefault()
        axios.post('http://localhost:3000/auth/add_im_solde', {im})
        .then(result => {
  ...
  return (
    ...
    style={{ textAlign: "center", marginBottom: "0px"}}>
        <SideBar/>
        <div className='p-3  border  p-3 mb-5 bg-white rounded' style={{ boxShadow: "0 4px 8px rgba(0, 0, 0, 0.2)", marginTop: "50px"}}>
